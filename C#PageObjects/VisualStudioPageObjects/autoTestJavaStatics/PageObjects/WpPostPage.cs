...
{
    abstract class WpPostPage : WpPage
    {
        ...
        public static void AddComment(string commentText, string commentAuthorEmail, string commentAuthorName, IWebDriver driver)
        {
        ...
        public static bool IsCommentPosted(string commentText, string commentAuthorName, IWebDriver driver)
        {
        ...
        public static void AddReplyToComment(string commentText, string commentAuthorName, string replyText, string replyAuthorEmail, string replyAuthorName, IWebDriver driver)
        {
            By commentLocator = GetPostedCommentLocator(commentText, commentAuthorName);
        ...
        public static bool IsReplyPosted(string commentText, string commentAuthorName, string replyText, string replyAuthorName, IWebDriver driver)
        {
            By commentLocator = GetPostedCommentLocator(commentText, commentAuthorName);
            IWebElement postedComment = driver.FindElement(commentLocator);
